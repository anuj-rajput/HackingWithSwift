...
class ViewController: UICollectionViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let optionAc = UIAlertController(title: nil, message: nil, preferredStyle: .actionSheet)
        optionAc.addAction(UIAlertAction(title: "Rename person", style: .default) { [weak self, weak optionAc] _ in
            ...
            optionAc?.dismiss(animated: true) { [weak self] in
